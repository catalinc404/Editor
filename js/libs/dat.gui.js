...
var GUI = function GUI(pars) {
  ...
  this.__listening = [];
  this.__resizeCallback = params.resizeCallback;
...
Common.extend(GUI.prototype,
{
  ...
  addFolder: function addFolder(name, buttons) {
    ...
    var newGuiParams = { name: name, parent: this, buttons: buttons, resizeCallback: this.__resizeCallback };
